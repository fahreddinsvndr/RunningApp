...
import com.androiddevs.runningappyt.other.Constants.FASTEST_LOCATION_INTERNAL
import com.androiddevs.runningappyt.other.Constants.LOCATION_UPDATE_INTERNAL
...
import com.androiddevs.runningappyt.other.Constants.TIMER_UPDATE_INTERNAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean){
        ...
        if (!serviceKilled){
            curNotificationBuilder = baseNotificationBuilder
                .addAction(R.drawable.ic_directions_run_black_24dp,notificationActionText,pendingIntent)
